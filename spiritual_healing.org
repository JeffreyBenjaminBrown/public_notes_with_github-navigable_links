...
* What if we already [[https://github.com/JeffreyBenjaminBrown/public_notes_with_github-navigable_links/blob/master/balance.org#recognize-bias-in-oneself-and-others][see through the bias]] I want to solve?
:PROPERTIES:
