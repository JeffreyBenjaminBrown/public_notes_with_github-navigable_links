...
*** [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/emacs/org_mode_emacs_major_mode.org][org-mode (Emacs major mode)]]
*** [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/emacs/csv_mode_emacs_package.org][csv-mode (Emacs package)]]
*** [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/emacs/dired_emacs_package.org][dired (Emacs package)]]
*** docker
*** evil-mode
...
*** markdown-toc
*** [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/emacs/neotree_emacs_package.org][neotree (Emacs package)]]
** easy
*** helm-file-preview
*** helm-taskswitch
*** helm-org
...
* DONE ? gave up on
** just didn't like it
*** [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/emacs/key_leap_emacs_minor_mode.org][key-leap (Emacs minor mode)]]
...
** [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/emacs/vertigo_emacs_package.org][vertigo]]
** helm-swoop
...
** [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/magit.org][magit]] (for git)
** [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/emacs/perspective_mode_for_emacs.org][perspective]] ("persp-mode")
** [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/emacs/deadgrep_emacs_package.org][deadgrep]]
** (smart-)hungry-delete
...
** [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/emacs/ace_window_emacs_package.org][ace-window (Emacs package)]]
** block-nav
...
** goto-last-change
** [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/emacs/ctrlf_emacs_package.org][ctrlf]] : text search
** restart-emacs
** DONE internalized
*** mwim
*** rainbow-delimiters
...
*** linum-relative (elpa)
*** [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/emacs/multiple_cursors_emacs_package.org][multiple cursors (Emacs package)]]
