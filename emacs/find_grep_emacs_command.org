...
* PITFALL: not just for Emacs
  ...
  But [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/emacs/find_grep_emacs_command.org#find-grep-for-org-roam][the script it uses]] works in Bash.
