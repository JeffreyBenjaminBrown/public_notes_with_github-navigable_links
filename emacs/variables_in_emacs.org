...
* PITFALL: [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/emacs/pitfall_avoid_half_initialized_values_emacs.org][Avoid half-initialized values. \ Emacs]]
...
* PITFALL: [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/emacs/scoping_rules_seem_complicated_in_emacs.org][Scoping rules seem complicated in Emacs.]]
* some kinds of variable scopes
  Each easy to find in manual.
  Sometimes these terms are hyphenated, sometimes not,
  inconsistently.
** [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/emacs/buffer_local_variables_in_emacs.org][buffer-local variables]]
