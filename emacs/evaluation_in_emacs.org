...
** [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/emacs/evaluation_in_emacs.org#pitfall--quotes-have-weird-mutability-implications-1][PITFALL : Quotes have weird mutability implications.]]
...
**** function
**** if
**** [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/emacs/interactive_emacs_function.org][interactive]]
**** lambda
**** let
**** let*
**** or
