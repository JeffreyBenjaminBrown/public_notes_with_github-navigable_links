...
*** Deadgrep offers the easiest way.
    ...
    probably tab.
*** Otherwise, [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/emacs/programmatically_hide_lines_from_a_file_in_emacs.org][programmatically hide lines from the file]].
