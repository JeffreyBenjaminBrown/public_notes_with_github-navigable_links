...
:END:
  syntax:
    rebar3 compile
* skipped sections of [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/rebar3_erlang_build_manager.org#rebar3-basic-usage][Rebar3: Basic Usage]]
** where output goes
** testing
