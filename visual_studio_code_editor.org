...
* PITFALL: Different from [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/visual_studio_ide.org][Visual Studio (IDE)]]
* there's also a libre version, [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/vscodium.org][VSCodium]]
* some commands
