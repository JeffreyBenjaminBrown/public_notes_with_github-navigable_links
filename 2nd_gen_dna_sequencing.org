...
"It spies on [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/how_dna_is_copied.org][How DNA Is Copied]]."
* the process
** basically
Chops up the DNA into short single-strand subsets,
and puts them on a flat surface (billions on a single slide),
scattered randomly.
Then add DNA polymerase, and [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/terminated.org][terminated bases]].
Then take a photo.
...
** The solution: [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/base_caller_software.org]["Base Caller" Software]]
