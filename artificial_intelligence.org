...
* common movie|film prompt
Without revealing anythign about the plot or even characters, can you tell me about the *feel* of the movie Wuthering Heights? What kind of ideas does it engage with? What do audiences and critics think?
* [[https://github.com/JeffreyBenjaminBrown/public_notes_with_github-navigable_links/blob/master/singularity.org][singularity]]
* Obvious common requirements are a good AI use case.
** example
   e.g. "here's my todo list for moving. What am I forgetting?"
** why it's good
   Recognizing a good idea you've forgotten
   is easier than generating a complete list fresh.
* [[https://github.com/JeffreyBenjaminBrown/public_notes_with_github-navigable_links/blob/master/is_testing_late_in_a_refactor_an_ai_pitfall.org][Is testing late in a refactor an AI pitfall?]]
* a tool for branching and merging context sequences
  https://ericmjl.github.io/blog/2025/12/31/canvas-chat-a-visual-interface-for-thinking-with-llms/
* Jan 2025, "Current general purpose AI revenue is 0.25% of America’s GDP, so this straightforwardly starts to have major effects by 2028."
  OpenAI alone at 18 billion/year
    per Zvi Mowshowitz,
    https://x.com/TheZvi/status/2009277777267093635
* ? Isolate responsibilities so clean code doesn't matter?
  Can I isolate the responsibilities of a funciton,
  and test it sufficiently,
  that I don't need to worry about whether
  the AI-generated implementation is clean?
* [[https://github.com/JeffreyBenjaminBrown/public_notes_with_github-navigable_links/blob/master/ai_prompting_tricks_structures.org][AI structuring & prompting tricks]]
* fun to ask
** Good morning! Please read this to get acquainted.
** Before you increase complexity, and/or write anything that feels duplicative, ask me about it.
* due diligence when coding with AI
** understand the whole pipeline before asking
   before asking for something be plugged into it
...
** [[https://github.com/JeffreyBenjaminBrown/public_notes_with_github-navigable_links/blob/master/intent_as_posterior_construction.org#claude-on-intent-as-posterior-construction-2025-09-28-sun][Claude wrote about]]  [[https://github.com/JeffreyBenjaminBrown/public_notes_with_github-navigable_links/blob/master/intent_as_posterior_construction.org][intent as posterior construction]].
...
** refs
*** instances
**** I use [[https://github.com/JeffreyBenjaminBrown/public_notes_with_github-navigable_links/blob/master/claude_code.org][Claude Code]].
...
**** ones for [[https://github.com/JeffreyBenjaminBrown/public_notes_with_github-navigable_links/blob/master/ai_and_art.org][AI and art]]
*** to learn to (? code) AI
:PROPERTIES:
...
**** some seemingly good ideas from a comment on HN
***** it
...
***** copies of it
****** the original : https://news.ycombinator.com/item?id=33932594
****** https://mail.google.com/mail/u/0/#inbox/QgrcJHsThhXQXmMwRbRkMfnllGlPjMlmLGq
** usage, goals
*** Name the standard solution.
*** Explain why I think a solution exists.
...
*** [[https://github.com/JeffreyBenjaminBrown/public_notes_with_github-navigable_links/blob/master/gpt_can_give_career_advice.org][LLMs can give multifaceted career advice.]]
*** summarizing things
...
** usage, methods
*** ? LLMs can adopt personalities.
**** Should I ask for this?
**** It could be efficient.
     It could be that in some cases
     the {easiest, clearest} way to explain another's experience
     is to adopt their voice.
...
:END:
    Whenever an AI ends a response with a question,
    I can't help but think, "Aww, it wants more experience".
...
** fantasy
*** 'training', like past lives, sweetly near-forgotten
:PROPERTIES:
:ID:       b3ac3b15-21ca-4379-96ec-acd0e880bef7
:END:
** running it
*** graphics cards
...
**** the best cheap ones on that list
     GTX 1060: $130
     RTX 3050: $175
* [[https://github.com/JeffreyBenjaminBrown/public_notes_with_github-navigable_links/blob/master/interview_with_claude_2025_12_28_sun.org][Claude on its experience if any, <2025-12-28 Sun>]]
