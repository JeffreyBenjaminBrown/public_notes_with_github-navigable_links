...
:END:
  ...
  and it still worked.
* [[https://github.com/JeffreyBenjaminBrown/secret-org/blob/master/phanaeros_s_2022_beelink_server.org][Phanaeros's 2022 Beelink server]]
...
** TODO Do I even use that libuv derivation?
   ...
   I may have [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/nixos_packages_create_build_install_publish.org#3---commands-to-build-it][installed libuv by hand]],
...
* TODO [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/emacs/emacs_mostly_packages.org#todo-do-i-want-org-roam-to-work-with-company-helm-both][do I want org-roam to work with company? helm? both?]]
* TODO [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/nixos_my_config_imperative_elements.org][imperative shell stuff to run]]
...
which uses PulseAudio to feed the mic into [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/cheese.org][cheese]]
...
/etc/tmux.conf
~/.stack/config.yaml
* [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/monome.org#installing-monome-code-on-nixos][monome, installing code on NixOS]]
