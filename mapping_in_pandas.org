...
* PITFALL: [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/don_t_use_the_axis_keyword_when_applying_to_a_series.org][Don't use the "axis = " keyword when applying to a Series.]]
