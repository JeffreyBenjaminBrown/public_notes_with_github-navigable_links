...
** skgnode_for_orgnode_in_tree is wrong
...
** TODO edit foreign node = quietly create overriding subscriber
...
** two ways (both deletions) to hide a node H from a local node L
*** suppose
**** F is a foreign node
...
** directly editing subscribes and overrides relationships
   Same as aliases.
