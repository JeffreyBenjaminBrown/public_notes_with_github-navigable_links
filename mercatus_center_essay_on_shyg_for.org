...
The extreme expressivity of the query language, and the extremely broad nature of the index, will permit a wide variety of desirable applications. In the next section I will sketch [[https://github.com/JeffreyBenjaminBrown/public_notes_with_github-navigable_links/blob/master/mercatus_center_essay_on_shyg_for.org#some-things-shyg-will-enable][some potential applications]], and in the process, introduce some of Shyg's key architectural ideas. Then I will describe [[https://github.com/JeffreyBenjaminBrown/public_notes_with_github-navigable_links/blob/master/mercatus_center_essay_on_shyg_for.org#an-overview-of-shygs-architecture][Shyg's architecture]]. After that I will examine Shyg's technical and economic [[https://github.com/JeffreyBenjaminBrown/public_notes_with_github-navigable_links/blob/master/mercatus_center_essay_on_shyg_for.org#feasibility][feasibility]], including open questions. Last, I will describe in the project's budget requirements. (And then there are footnotes.)

If the promises in the first section seem outlandish, perhaps consider skipping to the [[https://github.com/JeffreyBenjaminBrown/public_notes_with_github-navigable_links/blob/master/mercatus_center_essay_on_shyg_for.org#an-overview-of-shygs-architecture][architecture section]] to see how I plan to do it. And if the architectural overview seems too easy, perhaps consider skipping to the [[https://github.com/JeffreyBenjaminBrown/public_notes_with_github-navigable_links/blob/master/mercatus_center_essay_on_shyg_for.org#feasibility][feasibility section]], where I describe plainly the hard problems I foresee.
...
That last component, [[https://github.com/JeffreyBenjaminBrown/public_notes_with_github-navigable_links/blob/master/mercatus_center_essay_on_shyg_for.org#the-hash-query-language][Hash]], I wrote myself, albeit without support for federated queries. I intend to rewrite it it in TypeQL, the query language for [[https://github.com/JeffreyBenjaminBrown/public_notes_with_github-navigable_links/blob/master/mercatus_center_essay_on_shyg_for.org#the-typedb-hypergraph-database][TypeDB]], an open-source hypergraph database. Unlike TypeQL, Hash resembles natural language.
...
:END:
It will surely be a long time, if ever, before Shyg has indexed as many sites as Google has. Nevertheless, over the portion of the internet that Shyg's users choose to index (see "[[https://github.com/JeffreyBenjaminBrown/public_notes_with_github-navigable_links/blob/master/mercatus_center_essay_on_shyg_for.org#determining-what-to-index-and-in-how-much-detail][determining what to index, and in how much detail]]", below), Shyg will be able to answer queries that no other search engine can. This is because both the hypergraph index and the language for querying it will be more expressive than anything that has come before.
