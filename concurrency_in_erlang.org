...
* some vocab
** [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/concurrent_programming.org#some-vocab][some concurrent programming vocab]]
* errors
:PROPERTIES:
...
* [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/concurrency_in_erlang.org#signals-1][signals]]
* processes
...
*** Processes can terminate themselves.
    ...
    `erlang:error/1-2` [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/concurrency_in_erlang.org#can-be-emulated][emulates a runtime crash]].
...
****** [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/concurrency_in_erlang.org#if-caller-has-a-nonempty-mailbox-a-receive-in-a-subfunction-will-immediately-read-it][An example.]]
...
** [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/concurrency_in_erlang.org#the-four-standard-otp-behaviors-1][the four standard OTP behaviors]]
...
**** gen_server:call( Server_name, message ).
     ...
     Triggers [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/concurrency_in_erlang.org#handle_call][`handle_call`]] in the server.
...
***** They each get [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/concurrency_in_erlang.org#event-types--event-content][Event Type and Event Content]] args.
***** When working normally, should return one of these.
      {next_state, NextState, NewData, [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/concurrency_in_erlang.org#transition-actions][TransitionActions]]}
      {next_state, NextState, NewData}
****** Other options are unnecessary but maybe clearer.
       {keep_state, NewData, [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/concurrency_in_erlang.org#transition-actions][TransitionActions]]}
       {keep_state, NewData}
       {keep_state_and_data, [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/concurrency_in_erlang.org#transition-actions][TransitionActions]]}
       keep_state_and_data
       {repeat_state, NewData, [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/concurrency_in_erlang.org#transition-actions][TransitionActions]]}
       {repeat_state, NewData}
       {repeat_state_and_data, [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/concurrency_in_erlang.org#transition-actions][TransitionActions]]}
...
***** When it has to stop, should return one of these.
      ...
      {stop_and_reply, Reason, ReplyActions}
        ...
        but first execute the given [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/concurrency_in_erlang.org#transition-actions][TransitionActions]]
...
***** Like gen_server, there's also a [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/concurrency_in_erlang.org#todo-what-does-gen_serverstart_link-link-to][`start` alternative of `start_link`]].
...
****** much like [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/concurrency_in_erlang.org#handle_call--request-from-state---response][handle_call]]
****** valid response formats
       {noreply,NewState}
       {noreply,NewState,Timeout}
       {noreply,NewState,hibernate}
...
**** gen_server:reply/2
     Useful when you'd like to [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/concurrency_in_erlang.org#noreply-tells-the-server-not-to-reply][handle the reply yourself]],
...
****** TODO "global" events?
**** [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/concurrent_programming.org#when-to-prefer-synchronous-or-asynchronous-comms][synchronous vs. asynchronous communication: when to prefer which]]
**** [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/concurrent_programming.org#designing-asynchronous-protocols][designing asynchronous protocols]]
