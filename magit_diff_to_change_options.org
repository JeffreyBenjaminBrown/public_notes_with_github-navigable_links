...
* [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/magit.org#to-save-settings-eg-diff-persistently][to save settings (e.g. diff) persistently]]
