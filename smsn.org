...
** document how to [[https://github.com/JeffreyBenjaminBrown/public_notes_with_github-navigable_links/blob/master/smsn.org#build-the-dockerfile][build the Dockerfile]]
* TODO change smsn
