...
* see also
** [[https://github.com/JeffreyBenjaminBrown/public_notes_with_github-navigable_links/blob/master/osc_gen_conflicts_from_external_edits.org][conflicts from external edits]]
* a plan
