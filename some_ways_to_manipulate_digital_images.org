...
* [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/pitfalls_when_converting_pdfs.org][PITFALLS when converting (to or from) PDFs]]
...
** the math, the right way, I think
   [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/to_transform_a_rectangular_grid_to_a_hexagonal_one.org][to transform a rectangular grid to a hexagonal one]]
** my algorithm
*** start like this
...
#+END_SRC
* [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/how_to_concatenate_mixed_format_images_into_a_pdf.org][how to concatenate mixed-format images into a pdf]]
* [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/downsample_images_and_pdfs_with_ghostscript.org][downsample images and pdfs with ghostscript]]
...
* imagemagick can do [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/linear_algebra.org#affine-transformations][affine transformations]], e.g. "shear"
