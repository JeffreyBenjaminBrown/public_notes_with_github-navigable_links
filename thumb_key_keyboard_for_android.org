...
* how to extend it
  See the README or the [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/thumb_key_keyboard_for_android.org#builtin-user-guide][builtin documentation]].
