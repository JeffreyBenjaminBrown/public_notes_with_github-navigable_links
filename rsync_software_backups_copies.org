...
* how I usually run it
  ...
  with [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/rsync_software_backups_copies.org#pitfall-trailing-slash--unwrapped-content][no trailing slashes]] on any of the sources.
** PITFALL: This modifies files but deletes nothing
   because I'm not using [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/rsync_software_backups_copies.org#pitfall-the-popular-delete-option-is-dangerous][the scary `delete` option]].
* useful options
