...
* pkill -f : for when a process won't be killed by name
  [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/firefox_web_browser.org#to-kill-all-firefox-instances][Firefox, for instance, is like this.]]
