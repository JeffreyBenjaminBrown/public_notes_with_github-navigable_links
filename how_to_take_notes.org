...
** [[https://github.com/JeffreyBenjaminBrown/secret-org/blob/master/reading.org#todo-pages-from-andy-matuschaks-knowledge-graph-with-links-i-havent-gotten-to][pages from Andy Matuschak's knowledge graph with links I haven't gotten to]]
* how
** the para method
