...
* Hode would make it easier to detect astroturfed attacks.
  Sometimes what appears like an overwhelming popular response is in fact orchestrated by a single actor or a handful of actors. As described in [[https://github.com/JeffreyBenjaminBrown/public_notes_with_github-navigable_links/blob/master/bot_networks_and_hode.org][Hode vs. bot networks]], Hode would make it easier to identify a handful of actors working in concert.
...
* [[https://github.com/JeffreyBenjaminBrown/public_notes_with_github-navigable_links/blob/master/circles_of_publication_intimacy_could_protect_people_from_cancellation.org][Circles of publication intimacy could protect people from cancellation.]]
