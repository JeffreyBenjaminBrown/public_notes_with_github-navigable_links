...
* [[https://github.com/JeffreyBenjaminBrown/secret-org/blob/master/aws_credentials.org][stuff I've made]]
* solutions
...
*** Create a [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/aws_iam_identity_access_management.org#create-an-iam-policy-for-total-access-to-an-s3-bucket][policy for total access to the bucket]].
...
*** TODO It would be easy to determine whether [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/aws_iam_identity_access_management.org#and-maybe-the-following-or-maybe-they-have-no-effect][these]] matter
