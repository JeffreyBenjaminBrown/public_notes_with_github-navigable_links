...
*** [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/concurrency_in_go.org#if--c-is-an-argument-to-a-function-the-whole-function-evaluates][If (<-ch) is an argument to a function, the whole function evaluates.]]
...
*** implication: [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/concurrency_in_go.org#unbuffered-channels-synchronize-processes-1][(Unbuffered) channels synchronize processes.]]
...
**** [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/concurrency_in_go.org#unbuffered-channels-synchronize-processes-1][(Unbuffered) channels synchronize processes.]]
...
:END:
**** source: 10:22 in [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/advanced_go_concurrency_patterns_talk_on_video.org][Advanced Go Concurrency Patterns]]
...
** wait for something to close before closing
   17:43 in [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/advanced_go_concurrency_patterns_talk_on_video.org][Advanced Go Concurrency Patterns]]
