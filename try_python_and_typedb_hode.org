...
**** [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/typedb/solutions_in_typedb_some.org#in-bash-write-it-to-a-file][In Bash, how to write the schema to a file.]]
