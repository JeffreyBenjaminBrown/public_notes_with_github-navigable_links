...
* [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/emacs/find_grep_emacs_command.org][find-grep]]
* [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/find_sed.org][find-sed]]
* [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/find_sed.org#find-sed-without-touching-files-that-dont-need-modification][find-sed without touching files that don't need modification]]
* -L : follow symbolic links
  tag symlink
* [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/shell_tools_for_structured_data.org][shell tools for structured data]] (CSV, JSON, etc.)
* [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/grep_command_line_search_utility.org][grep (command line search utility)]]
