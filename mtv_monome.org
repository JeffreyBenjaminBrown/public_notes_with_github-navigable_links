...
#+title: mtv-monome
* refs
** [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/montevideo_synth_axe.org][Montevideo.Synth.Axe]]
* TODO UNFINISHED
** timbre interface
...
*** prime number interface for modulators
    Really needs [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/mtv_monome.org#presets-accessible-and-writeable-via-buttons][presets accessible and writeable via buttons]]
** Use Sound.OSC.FD
*** how
...
* TODO [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/add_in_between_notes_to_mtv_monome.org][add in-between notes to mtv-monome]]
...
* handy references
** [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/supercollider_software_audio.org][Supercollider (software, audio)]]
