...
* How to do it
  ...
  to insert [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/git_rebase_rewrite_history.org#some-examples-of-commit-edit-commands][a commit edit command]].
