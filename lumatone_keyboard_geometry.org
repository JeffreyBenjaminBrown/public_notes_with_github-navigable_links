...
* how to [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/some_ways_to_manipulate_digital_images.org#shear-a-rectangular-grid-to-fit-the-lumatone-hex-layout][shear a rectangular grid image to fit the Lumatone hex layout]]
* pictures
** the key numbers
...
*** based on these images
    [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/lumatone_keyboard_geometry.org#a-picture-in-color-of-the-full-keyboard][a picture in color]]
    [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/lumatone_keyboard_geometry.org#a-black-and-white-hex-diagram-of-the-key-region-with-no-numbers][a black and white picture to print]]
* my reach
  A function (Haskell)
