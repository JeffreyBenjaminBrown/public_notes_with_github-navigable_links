...
* TODO [[https://github.com/JeffreyBenjaminBrown/public_notes_with_github-navigable_links/blob/master/what_is_the_source_of_an_org_roam_link.org][What is the source of an org-roam link?]]
* to view it
** from Bash
...
*** then run a query like [[https://github.com/JeffreyBenjaminBrown/public_notes_with_github-navigable_links/blob/master/exploring_the_org_roam_db.org#some-queries][one of these]]
* some queries
:PROPERTIES:
...
** [[https://github.com/JeffreyBenjaminBrown/public_notes_with_github-navigable_links/blob/master/exploring_the_org_roam_db.org#schema-links][The `properties` field in the `links` table does this too.]]
