...
** [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/logic_formal.org#material-implication-antecedent-consequence-and-converse-1][(material) implication, antecedent, consequence, and converse]]
** [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/logic_formal.org#conjuncts-and-conjunctions-1][conjuncts and conjunctions]]
** [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/logic_formal.org#disjuncts-and-disjunctions-1][disjuncts and disjunctions]]
** Well-formed formula = WFF
* PITFALLs
** Some texts use different symbols.
* my notes, ordered like [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/logic_formal.org#ref][the book]]
...
****** ≡ (equivalence)
***** They are all [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/logic_formal.org#truth-functional-operators][truth-functional]].
