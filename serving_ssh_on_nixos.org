...
** will need to use wpa_supplicant
   ...
   once I've [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/serving_ssh_on_nixos.org#conflicting-networking][removed networkmanager from my config]].
