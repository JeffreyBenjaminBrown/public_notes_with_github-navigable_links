...
* PITFALL: [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/nixos_unstable_means_lots_of_rebuilding.org][nixos-unstable means lots of rebuilding]]
...
** Read the latest release notes to see if there's anything extra to do.
   For instance, moving
   [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/nixos_how_to_upgrade_channels.org#how-i-went-from-1909-to-2003][going from 19.09 to 20.03 required a bit more than a channel change]].
