...
**** TODO See also "interests", which [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/hypothesis_person_interests_person_outbox.org][might dominate]] this field.
*** contact info
*** schedule
...
** After interaction, bump their name to the top of my [[https://github.com/JeffreyBenjaminBrown/secret-org/blob/master/people_i_like_talking_to_find_interesting.org][contacts of interest]].
