...
** easy to see if you pretend the 11 isn't there in the [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/17_53_x_3_53_isomorphic_note_layout.org#layout][layout]]
* layout
:PROPERTIES:
