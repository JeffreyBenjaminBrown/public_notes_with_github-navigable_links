...
* [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/lily_foster_s_build_of_sc3_plugins.org][Lily Foster's build of sc3-plugins]]
  It's way better than mine.
* [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/sc3_plugins_supercollider_tools.org#pitfall-on-nixos-using-sc-with-plugins-requires-some-configuration][PITFALL: On NixOS, using SC with plugins requires some configuration.]]
