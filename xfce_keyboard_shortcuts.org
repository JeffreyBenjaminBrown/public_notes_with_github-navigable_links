...
:END:
  After [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/xfce_keyboard_shortcuts.org#how-to-find-them][finding the list]], it's obvious how to add one,
  but it doesn't work.
