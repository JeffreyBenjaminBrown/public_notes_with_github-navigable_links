...
:END:
#+title: how Skg works
* TODO revise [[https://github.com/JeffreyBenjaminBrown/public_notes_with_github-navigable_links/blob/master/how_skg_works.org#viewing-the-data][viewing the data]]
...
** [[https://github.com/JeffreyBenjaminBrown/public_notes_with_github-navigable_links/blob/master/how_skg_works.org#each-section-subsection-etc-is-a-node-or-org-node][OrgNode]]
...
** the graph
   ...
   More on the graph [[https://github.com/JeffreyBenjaminBrown/public_notes_with_github-navigable_links/blob/master/how_skg_works.org#the-graph-1][below]].
** the 'client'
...
**** link appearance
     ...
     can have [[_][any]] number of [[_][links]] with [[:id:long-number][any title, however misleading -- broken link?]].
**** why use links
