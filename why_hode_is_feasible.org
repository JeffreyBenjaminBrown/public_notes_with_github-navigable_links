...
In [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/hode_would_resemble_a_mix_of_familiar_applications.org][what Hode would be like]] are listed five kinds of platforms that Hode would combine into a single experience. It sounds amibitious. It is. But it is at least technically feasible.
* the sharing
...
Deep queriability would enable a wealth of applications currently infeasible, as described in [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/problems_hode_might_help.org][problems Hode might solve (or at least help)]] and [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/capabilities_hode_could_enable.org][things Hode would enable]].
