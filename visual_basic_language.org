...
* TODO reading
** PAUSED INDEFINITELY : [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/vb_language_reference_notes_from.org][VB language reference, notes from]]
* TODO learn about
  testing
  ...
  HTTP
* TODO questions
** [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/visual_basic_language.org#dim-is-used-to--allocate-memory-1]["Dim" is used to ... allocate memory?]]
* [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/visual_basic_building_and_running.org][building and running]]
* syntax
** comments
   are preceded by '
** import statements
