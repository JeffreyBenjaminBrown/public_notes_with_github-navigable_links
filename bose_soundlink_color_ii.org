...
* PITFALL: If it always stutters in Bluetooth mode, [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/bose_soundlink_color_ii.org#how-to-reset][reset it]].
* manual
