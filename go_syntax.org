...
:END:
#+title: Go syntax
* [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/imports_in_go.org][imports in Go]]
...
**** TODO Right?
*** [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/go_syntax.org#todo-is-a-pointer-needed-for-a-function-to-modify-any-argument-or-only-structs][Is a pointer needed for a function to modify *any* argument, or only structs?]]
** maps
...
**** assign to an array
     a[0] = "Hello"
**** [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/go_syntax.org#slice-literals--array-literals-2][Slice literals & array literals.]]
...
** [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/go_syntax.org#break-statements-in-go-2][`break` statements in Go]]
* conditions
** if [else]
*** if x < 0 { ... }
...
*** switching on arbitrary conditions
    ...
    switch {
       ...
       case z < w: ...
*** [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/go_syntax.org#break-statements-in-go-2][`break` statements in Go]]
*** [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/go_syntax.org#type-switches-1][type switches]]
* execution order
:PROPERTIES:
...
*** Methods and their receiver types must be declared in the same package.
    Potentially useful: [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/go_syntax.org#type-synonyms][type synonyms]].
*** Pointer receivers
**** two motivations
...
**** Nil interface values are useless.
     ...
     a concrete value.
     Confusingly, [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/go_syntax.org#todo-non-nil-interfaces-hodling-nil-values-are-weird][even if the assigned value is a nil pointer,
...
:END:
**** explanation
     As in a [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/go_syntax.org#type-assertions][type assertion]], here `v`
...
**** syntax
     ...
     switch v := i.(type) {
       ...
       default:
         ...
         // (but [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/go_syntax.org#todo-is-it-a-copy][it might be a copy]]).
     }
***** TODO Is it a copy?
:PROPERTIES:
