...
* [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/static_files_in_django_esp_for_stylesheets_and_images.org#upload-permissions][how the staticfiles app handles uploads and permissions]].
* ref
