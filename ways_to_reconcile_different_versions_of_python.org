...
* things I tried, [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/ways_to_reconcile_different_versions_of_python.org#done-from-django-use-the-csv-package-rather-than-pandas][the successful one]] of which was an ugly hack
  alternatives
