...
** [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/nixos_packages_create_build_install_publish.org#installed-cc-libraries-are-not-ordinarily-available-1][installed C/C++ libraries are not ordinarily available]]
* how to do it
