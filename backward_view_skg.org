...
*** hard, desirable : weight the containers that link to it
    by how much they contain,
    maybe also taking into account recency of, amount of activity
*** definition
...
* might be redundant
  'Appears with other link targets in the title of a node with contents' and 'is the sole link target in a node'
