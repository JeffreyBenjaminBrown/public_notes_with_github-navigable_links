...
** [[https://github.com/JeffreyBenjaminBrown/secret-org/blob/master/TidalCycles/steady_beat_falling_sample_speed_distorted_echo_swing.org][superimpose a swung echo]]
#+BEGIN_SRC haskell
d1 $ superimpose
      ( late (2/12) .
	(|* distort 0.3) .
...
#+END_SRC
** [[https://github.com/JeffreyBenjaminBrown/secret-org/blob/master/TidalCycles/stereo_beat_with_superimposed_faster_comb.org][stereo beat with superimposed faster comb]]
* [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/TidalCycles/layer-apply-list-of-functions-in-parallel.org][layer : apply list of functions in parallel]]
