...
* PITFALL: There are numerous pieces to update.
  ...
  SuperCollider
  the SuperDirt quark
  the Emacs extension (actually [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/TidalCycles/using_running_tidalcycles_in_emacs.org#use-a-local-tidal-clone-from-emacs-without-using-tidalel][I prefer not to]])
  Tidal
...
** This even [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/TidalCycles/using_running_tidalcycles_in_emacs.org#use-a-local-tidal-clone-from-emacs-without-using-tidalel][works in Emacs]].
