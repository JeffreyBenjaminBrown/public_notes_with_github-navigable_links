...
*** DONE I no longer need to add a line to specify `ugenPluginsPath`.
    ...
    [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/sc3_plugins_supercollider_tools.org#pitfall-on-nixos-using-sc-with-plugins-requires-some-configuration][Details here]].
* use it with Emacs
  alternatives
...
**** open a buffer for Tidal code
     ...
     or an org file like
       [[https://github.com/JeffreyBenjaminBrown/secret-org/blob/master/TidalCycles/song_attempt_1_tidal.org][song attempt 1 \ Tidal]]
