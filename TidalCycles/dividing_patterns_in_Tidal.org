...
** [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/TidalCycles/fugue_from_superimposing_a_transposed_iter_on_a_panning_arpeggio.org][fugue from superimposing a transposed iter on a panning arpeggio]]
...
#+END_SRC
*** [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/TidalCycles/a_time_varying_trunc_makes_a_simple_pattern_complex.org][A time-varying `trunc` can make a simple pattern complex.]]
...
#+END_SRC
** [[https://github.com/JeffreyBenjaminBrown/secret-org/blob/master/TidalCycles/chunking_a_distorted_harmony.org][chunking a distorted harmony]]
