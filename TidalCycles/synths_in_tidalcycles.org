...
modfreq = pF "modfreq"
#+END_SRC
* TODO [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/TidalCycles/synths_in_tidalcycles.org#todo-there-are-a-lot-more-with-provocative-names][there are a lot more, with provocative names]]
* a partial list
...
**** voice     = 0.5 : pulse width
     ...
     Inaudible at 0 or 1.
     [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/TidalCycles/synths_in_tidalcycles.org#varying-voice-phase-width-quickly-in-a-single-pitch][Fun thing to vary quickly]].
**** decay     = 0
**** sustain   = 1
**** semitone  = 12
**** rate      = 1
