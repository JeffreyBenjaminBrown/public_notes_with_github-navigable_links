...
* TODO ? skipped
** [[https://github.com/JeffreyBenjaminBrown/public_notes_with_github-navigable_links/blob/master/rust.org#todo--i-skipped-some-of-this-content][lifetime elision rules]]
* tooling
...
#+end_src
*** [[https://github.com/JeffreyBenjaminBrown/public_notes_with_github-navigable_links/blob/master/rust.org#move-in-closures-1][`move` in closures]]
...
**** [[https://github.com/JeffreyBenjaminBrown/public_notes_with_github-navigable_links/blob/master/rust.org#main-can-return--result-more][`main` can return () or Result.]]
...
#+end_src
** scope
*** [[https://github.com/JeffreyBenjaminBrown/public_notes_with_github-navigable_links/blob/master/rust.org#scope-lifetimes-and-dangling-pointers--an-error][scope, lifetimes and dangling pointers]]
** smart pointers
...
**** [[https://github.com/JeffreyBenjaminBrown/public_notes_with_github-navigable_links/blob/master/rust.org#the-deref-trait][The Deref trait]] abstracts over both.
...
*** Async is for [[https://github.com/JeffreyBenjaminBrown/public_notes_with_github-navigable_links/blob/master/concurrent_programming.org#parallel-vs-concurrent][concurrency, not parallelism]].
...
** orphans
*** Options
**** [[https://github.com/JeffreyBenjaminBrown/public_notes_with_github-navigable_links/blob/master/rust.org#-also-applies-to-options][? also applies to Options.]]
**** [[https://github.com/JeffreyBenjaminBrown/public_notes_with_github-navigable_links/blob/master/rust.org#there-are-functions-for-converting-between-option-and-result][There are functions for converting between Option and Result.]]
...
* DONE solved
** [[https://github.com/JeffreyBenjaminBrown/public_notes_with_github-navigable_links/blob/master/cargo_and_apt_stopped_working_in_docker.org][cargo and apt stopped working in Docker, could not connect]]
