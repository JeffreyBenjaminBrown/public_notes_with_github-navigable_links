...
* if I don't have internet access from within it
  ...
  [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/how_to_configure_wsl_to_use_an_internet_proxy.org][configure Linux (in this case WSL) to use an internet proxy.]]
