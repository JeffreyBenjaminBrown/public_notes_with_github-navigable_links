...
* DONE [[https://github.com/JeffreyBenjaminBrown/ofiscal/knowledge-graph/blob/master/tax_co_web_on_ec2.org#in-the-docker-container-update-pip-packages][in the Docker container, update pip packages]]
