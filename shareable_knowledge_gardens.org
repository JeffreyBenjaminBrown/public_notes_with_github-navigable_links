...
*** a TypeDB index
    see [[https://github.com/JeffreyBenjaminBrown/public_notes_with_github-navigable_links/blob/master/shareable_knowledge_gardens.org#skg-format][format]]
...
** implement [[https://github.com/JeffreyBenjaminBrown/public_notes_with_github-navigable_links/blob/master/shareable_knowledge_gardens.org#subscription][subscription]]
** implement [[https://github.com/JeffreyBenjaminBrown/public_notes_with_github-navigable_links/blob/master/shareable_knowledge_gardens.org#cloning][cloning]]
...
***** [[https://github.com/JeffreyBenjaminBrown/public_notes_with_github-navigable_links/blob/master/shareable_knowledge_gardens.org#subscription-data-1][subscription data]]
**** subscription data
:PROPERTIES:
...
**** later make them [[https://github.com/JeffreyBenjaminBrown/public_notes_with_github-navigable_links/blob/master/shareable_knowledge_gardens.org#flat-org-diff--for-private-lenses-onto-public-flat-org-files][diffs]]
** subscription
:PROPERTIES:
...
*** [[https://github.com/JeffreyBenjaminBrown/public_notes_with_github-navigable_links/blob/master/shareable_knowledge_gardens.org#subscription-data-1][data model]]
*** display
...
*** [[https://github.com/JeffreyBenjaminBrown/public_notes_with_github-navigable_links/blob/master/shareable_knowledge_gardens.org#how-to-show-and-filter-foreign-data][Subscribed content is filtered.]]
** cloning
:PROPERTIES:
...
** later ? [[https://github.com/JeffreyBenjaminBrown/public_notes_with_github-navigable_links/blob/master/oscillable_generations_view_for_org_roam.org][backlinks view]]
...
** [[https://github.com/JeffreyBenjaminBrown/public_notes_with_github-navigable_links/blob/master/shareable_knowledge_gardens.org#feasible-extensions][extend the file format]]
...
** "flat org diff" : for private lenses onto public [[https://github.com/JeffreyBenjaminBrown/public_notes_with_github-navigable_links/blob/master/shareable_knowledge_gardens.org#flat-org-with-subscriptions-and-private-commentary][flat-org]] files
:PROPERTIES:
...
** [[https://github.com/JeffreyBenjaminBrown/public_notes_with_github-navigable_links/blob/master/oscillable_generations_view_for_org_roam.org][oscillable generations view]]
** transclusion
