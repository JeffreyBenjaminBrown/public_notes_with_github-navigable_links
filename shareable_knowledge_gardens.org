...
** [[https://github.com/JeffreyBenjaminBrown/public_notes_with_github-navigable_links/blob/master/it_this_and_these_make_tree_relationships_easy.org][simple text tree graph relations]]
...
* TODO conceptual
** Rush to [[https://github.com/JeffreyBenjaminBrown/public_notes_with_github-navigable_links/blob/master/shareable_knowledge_gardens.org#to-replace-org-roam-in-my-own-usage][where I can use it for my own data]].
