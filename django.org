...
** [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/django_in_aws_esp_aws_eb.org][Django in AWS (esp. AWS EB)]]
...
** [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/file_uploads_in_django.org][File Uploads In Django]]
** [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/django_security_things_to_do_before_production.org][Django security, things to do before production]]
** [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/forms_in_django.org][forms in Django]]
* PITFALLs
...
*** TODO [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/apache_and_mod_wsgi_using_them_with_django.org][Apache and mod_wsgi: Using Them with Django]]
*** TODO "Sending emails"
...
* [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/paths_in_django.org][paths in Django]]
* requests in Django
...
***** maybe a folder for each app located in the project
  ...
  There never need to be, because [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/django.org#apps-can-live-anywhere-on-your-python-path][apps can live anywhere on your Python path]]
**** <project-root>/<site-name>/ needs to "know" about an app,
  as described in [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/django.org#connect-the-view-to-the-website][connect the view to the website]].
...
*** PITFALL: probably still need [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/django.org#to-install-an-app-in-a-project][to (install?) the app in the project]]
...
*** mysite/app/models.py
    explains the structure of a [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/the_django_database.org][Django Database]]
...
**** then make migrations for the app, and execute them
     see [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/django_database_migrations.org][Django Database Migrations]]
*** the "Django shell"
    start it with
...
** part 5: [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/testing_in_django.org][Testing in Django]]
** part 6: [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/static_files_in_django_esp_for_stylesheets_and_images.org][Static Files in Django, esp. for Stylesheets and Images]]
** part 7: [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/customizing_the_django_admin_form.org][Customizing The Django Admin Form]]
* The "topic guides"
...
"""
* solutions
** [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/ways_to_reconcile_different_versions_of_python.org][ways to reconcile different versions of Python]]
** [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/load_local_modules_into_the_django_shell.org][load local modules into the Django shell]]
