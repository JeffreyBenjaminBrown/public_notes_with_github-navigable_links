...
* PITFALL: Don't update packages installed from source via apk!
  I [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/installing_emacs_from_source_on_alpine_linux.org][installed Emacs]] that way.
...
* initial set up
  serial
** [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/alpine_linux.org#enable-community-packages][enable community packages]]
...
* [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/installing_emacs_from_source_on_alpine_linux.org][installing Emacs from source on Alpine Linux]]
