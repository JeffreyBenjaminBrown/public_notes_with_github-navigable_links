...
* PITFALL: csvlib writes Windows-style line terminators
  ...
  [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/csvlib_python_library.org#use-linux--not-windows-style-line-terminators][how to avoid that]]
