...
* The solution
  ...
  [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/midi-keyboard-esp-usb-in-linux-how-to-use.org#via-aconnect-on-the-command-line][do it via the command line]].
* links
** on Facebook
