...
* If it doesn't work, [[https://github.com/JeffreyBenjaminBrown/public_notes_with_github-navigable_links/blob/master/audio_plugin_scanning_problem_manually_installed_ones_found_nix_built_ones_not_found.org#a-solution][this might help]].
