...
** show track FX
   alternatives
*** [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/reaper/reaper_shortcuts_and_context_menus.org#show-fx-c-f][C-f]] is a shortcut I made.
*** click its FX button
:PROPERTIES:
...
* [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/reaper/mixing_buses_and_routing_in_reaper.org#sends-and-receives-can-be-before-or-after-fader-pan-and-fx][Sends and receives can be before or after fader, pan and FX.]]
