...
** [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/reaper/media_item_views_in_reaper.org][media items]]
...
* [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/reaper/undo_in_reaper.org][undo]]
* [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/reaper/overlapping_items_in_the_same_track_reaper.org]["Overlapping Items" in the same track]]
* [[id:63d1464e-4714-4e75-a538-21aa338d5b53][A whole sequence of [editing] actions can be given a keyboard shortcut.]]
* [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/reaper/stereo_and_channels_in_reaper.org][stereo and channels in Reaper]]
...
** deleting time
*** [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/ripple_editing_in_reaper.org][Ripple Editing in Reaper]]
*** [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/reaper/reaper_shortcuts_and_context_menus.org#delete-time--c-m-d][delete time : C-M-d]] (jbb-specific)
** trimming
...
**** [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/reaper/editing_audio_editing_media_items_in_reaper.org#enable-grouping--m-s-g][enable it : M-S-g]]
...
*** PITFALL: [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/reaper/pitfalls_reaper.org#propogating-items-means-propogating-an-items-properties-to-other-items][This is badly named.]]
*** the two varieties:
...
** [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/reaper/nudge_reaper.org#multiple-kinds-of-things-can-be-nudged][Multiple kinds of things can be nudged]], and not just in time.
