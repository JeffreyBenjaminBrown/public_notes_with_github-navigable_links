...
*** Glue it ("to itself") so that it forgets the trimmed-out regions.
    [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/reaper/editing_audio_editing_media_items_in_reaper.org#glue-items--c-s-g][glue item(s) : C-S-g]]
...
* It might help that [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/reaper/media_item_views_in_reaper.org#item-playback-rate-can-be-adjusted][playback rate can be adjusted]].
