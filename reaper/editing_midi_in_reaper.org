...
* [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/reaper/pitch_detection_pitch_shift_and_time_stretch_in_reaper.org#midi-stretch--reaper][midi stretch]]
* u
** [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/reaper/fast_channel_manipulations_in_reaper.org][fast channel manipulations in Reaper]]
...
** [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/reaper/pitfalls_reaper.org#there-are-two-actions-lists][There are two Actions Lists.]]
** [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/reaper/editing_midi_in_reaper.org#sync-editor-transport-to-project-transport][Sync editor transport to project transport]] could be off.
** [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/reaper/editing_midi_in_reaper.org#pitfall-mouse-can-toggle-cc-selection-follows-note-selection]["CC selection follows note selection"]] could be off.
...
:END:
** TODO play with [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/reaper/editing_midi_in_reaper.org#note-preview-options-are-interesting]["note preview" options]]
* HANDY things
...
:END:
   see the configuration option that begins
     One MIDI editor per
** for [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/reaper/reaper_and_microtonality.org][microtonality]]
* drum programming
  useful configuration options for it
** [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/reaper/editing_midi_in_reaper.org#a-named-notes-and-cc-channels][named notes]]
...
:END:
***** This permits [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/reaper/arbitrary_EDO_layouts_for_the_MIDI_editor_in_Reaper.org][arbitrary EDO layouts]]
***** noteworthy options
...
** [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/reaper/vocabulary_in_reaper.org#inline-edits]["inline" edits]] are possible
** create new note : mouse, or MIDI in, or F1-F12
*** [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/reaper/editing_midi_in_reaper.org#when-entering-notes-velocity-has-hysteresis][Velocity has hysteresis.]]
...
*** [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/reaper/fast_channel_manipulations_in_reaper.org#some-channel-operations-with-keyboard-shortcuts][channel operations, some]]
*** [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/reaper/mouse_and_keyboard_control_customization_in_reaper.org#with-the-keyboard][scrolling and zooming with the keyboard]]
...
:END:
** [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/reaper/grid_lines_and_snapping_reaper.org#snap-behavior-options-at-least-for-midi-notes][how snapping works]]
*** [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/reaper/grid_lines_and_snapping_reaper.org#soft-snap-notes-to-other-notes-----interesting][Soft snap notes to other notes]] might be nice.
...
** [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/reaper/editing_midi_in_reaper.org#the-same-file-can-contain-note-names-and-cc-channel-names][CC channels can be named]].
...
** MIDI Data Sends
** [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/reaper/editing_midi_in_reaper.org#14-bit-cc-values-are-possible][14-bit CC values]]
