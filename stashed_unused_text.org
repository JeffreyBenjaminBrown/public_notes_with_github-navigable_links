...
Outside of the database, the major innovation in Hode was its query language, [[https://github.com/JeffreyBenjaminBrown/public_notes_with_github-navigable_links/blob/master/mercatus_center_long_essay_on_shyg_for.org#the-hash-query-language][Hash]], which I intend to use (with some extension) in Shyg.
