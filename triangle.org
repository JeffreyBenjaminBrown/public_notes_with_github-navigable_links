...
** given the information [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/triangle.org#sas--side-angle-side][SAS]]
   Solve [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/triangle.org#the-law-of-cosines][the law of cosines]] for a:
     a = sqrt ( b**2 + c**2 -
                2 * b * c * cos A )
   As Haskell:
