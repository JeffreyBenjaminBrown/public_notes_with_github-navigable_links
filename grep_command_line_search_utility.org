...
* [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/grep_for_within_line_disjunction.org][grep for within-line disjunction]] (grep or)
* [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/strip_all_pyc_tag_and_files_from_tree_output.org][tree-grep]] : Strip some files from `tree` output.
