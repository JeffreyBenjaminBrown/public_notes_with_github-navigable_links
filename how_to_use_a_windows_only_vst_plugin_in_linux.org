...
* [[https://github.com/JeffreyBenjaminBrown/public_notes_with_github-navigable_links/blob/master/how_to_use_a_windows_only_vst_plugin_in_linux.org#pitfall-this-might-need-to-be-done-each-time-i-add-a-vst][PITFALL: `yabridgectl sync` might need redoing for new .]]
* steps, in serial
