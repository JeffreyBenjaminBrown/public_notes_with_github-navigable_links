...
** PITFALL: This only demonstrates the testing of functions.
   In my notes I documented [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/unittest_mock_python_library_for_testing.org#there-are-two-ways-to-mock-a-class-method][how to test a class method]],
...
:END:
*** Which to prefer
    According to [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/unittest_mock_python_library_for_testing.org#a-tutorial-and-the-source-of-most-of-these-data][the tutorial I like]],
