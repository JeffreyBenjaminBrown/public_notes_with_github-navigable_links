...
** this = single child
** these = children
* [[https://github.com/JeffreyBenjaminBrown/public_notes_with_github-navigable_links/blob/master/indicators_for_node_headings_in_trees.org#prefix-a-heading-rn-if-it-is-a-relation-of-arity-n][rel nodes are marked RN]]
