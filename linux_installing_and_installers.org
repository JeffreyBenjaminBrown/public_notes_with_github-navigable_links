...
** [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/kde.org][KDE]] is the cadillac.
...
** [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/xfce_desktop_environment.org][Xfce]] and Mate are the second-lightest mainstream desktop environments.
   They're about equally lightweight.
*** xfce is part of Xubuntu and other distros.
* Linux window managers
** [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/xmonad_window_manager.org][xmonad (window manager)]]
