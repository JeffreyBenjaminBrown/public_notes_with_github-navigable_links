...
* NAH [[https://github.com/JeffreyBenjaminBrown/stale-notes-from-org-roam.git/blob/master/try_recoloring_bullets_in_emacs_hode.org][automatically recolor user-drawn bullets in Emacs]]
