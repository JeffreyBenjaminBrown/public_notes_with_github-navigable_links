...
* to make requests
  See [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/http_in_erlang_the_inets_library.org#the-inets-client-user-guide][the Inets Client user guide]].
  Search for
