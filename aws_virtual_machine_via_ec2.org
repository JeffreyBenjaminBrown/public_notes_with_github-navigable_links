...
* [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/hibernation_for_aws_ec2.org][hibernation for AWS EC2]]
* [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/aws_ec2_wui.org][the EC2 WUI]]
* solutions
** [[https://github.com/JeffreyBenjaminBrown/secret-org/blob/master/aws_ec2_launch_an_instance_machine_from_the_cl.org][launch an EC2 instance from the CL]]
** [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/aws_ami_amazon_machine_image.org#to-launch-an-ec2-instance-from-an-ami][launch an EC2 instance from an AMI]]
** [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/aws_ami_amazon_machine_image.org#to-create-an-ami-from-an-ec2-instance][to create an AMI from an EC2 instance]]
...
** get IP(v4) addresses for running instance(s)
   First [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/aws_virtual_machine_via_ec2.org#describe-all-running-instances][describe them all in a file]].
   Then grep the file:
