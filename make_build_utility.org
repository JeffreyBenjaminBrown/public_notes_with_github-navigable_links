...
** make ignores symlinks!
   ...
   if it is a symlink.
* [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/parallel_processing_in_gnu_make_with_a_multi_output_rule_that_does_not_create_redundant_processes.org][parallel processing in GNU make with a multi-output rule that does not create redundant processes]]
* options I like
