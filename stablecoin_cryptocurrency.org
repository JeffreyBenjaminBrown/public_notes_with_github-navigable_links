...
** examples
   [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/gemini_dollar_gusd.org][Gemini Dollar (GUSD)]]
   Tether (USDT)
   True USD (TUSD)
   Paxos Standard (PAX)
...
** example: [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/dai_stablecoin.org][DAI]]
