...
** then test as normal
   ...
   def test_something():
     ...
     assert True
* [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/unittest_mock_python_library_for_testing.org][unittest.mock (Python library for testing with mocks)]]
