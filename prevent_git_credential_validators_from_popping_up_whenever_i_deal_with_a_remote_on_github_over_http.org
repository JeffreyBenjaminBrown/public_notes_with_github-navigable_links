...
* motivation
  http & github are how the repos in [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/agora_shared_knowledge_base_protocol.org][Agora]] are described --
