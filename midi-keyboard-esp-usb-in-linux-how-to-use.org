...
* steps
  serial
** [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/pianoteq_seems_to_be_getting_low_priority.org][Disable CPU throttling.]]
** Turn on QJackCtl.
** Run `[[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/a2jmidid_and_aconnect.org][a2jmidid]]` from a shell.
...
*** how to decide whether to do it graphically or via the shell
    [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/midi-keyboard-esp-usb-in-linux-how-to-use.org#if-the-keyboard-shows-up-in-the-qjackctl-signal-graph-it-can-be-connected-that-way-otherwise-connecting-it-requires-aconnect][If the keyboard shows up in the QJackCtl signal graph, it can be connected that way. Otherwise, connecting it requires `aconnect`.]]
*** alternatives
...
:END:
* [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/a2jmidid_and_aconnect.org#solved-bug-sometimes-aconnect-needs-to-be-rerun][SOLVED: BUG: Sometimes aconnect needs to be rerun.]]
