...
** a solution: Always use (a copy of) the latest data.
   ...
   (Note that this leaves [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/borg_backup_software.org#the-mystery][the mystery]] above unsolved.)
