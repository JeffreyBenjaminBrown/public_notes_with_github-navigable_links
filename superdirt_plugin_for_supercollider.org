...
** This probably is not required.
   Set `ugenPluginsPath` [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/sc3_plugins_supercollider_tools.org#pitfall-on-nixos-using-sc-with-plugins-requires-some-configuration][as required by my strange NixOS setup]].
...
* [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/TidalCycles/dirt_superdirt_samples.org][Dirt | SuperDirt samples]]
...
**** TODO "[[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/superdirt_plugin_for_supercollider.org#todo-decay-near-0-is-little-effect-near-1-is-very-staccato][decay]]" is useful
