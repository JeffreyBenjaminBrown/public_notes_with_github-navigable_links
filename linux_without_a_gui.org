...
** start it with [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/emacs/emacs_mostly_packages.org#run-emacs-in-terminal-without-opening-an-x-window][the -nw option]]
...
** PITFALL: Might [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/linux_without_a_gui.org#pitfall-right-alt-key-might-not-work][need to use the left Alt]] key.
