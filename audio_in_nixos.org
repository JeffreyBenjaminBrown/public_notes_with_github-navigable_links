...
* see also [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/audio_in_linux.org][audio in Linux]]
* references
...
* SOLVED
** Stutter, squeals, and silences/dropouts can sometimes be solves by [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/disable_cpu_throttling_for_each_core.org][disabling CPU throttling]].
** [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/pianoteq_seems_to_be_getting_low_priority.org][A synth plugin seemed to be getting low priority.]]
