...
** Deleted nodes are not children of the node that contained them.
   But they can be found as grandchildren,
   either under at least one DJC midparent,
   or under the orphan collector midparent.
** AWAITS later : maybe ordering matters
