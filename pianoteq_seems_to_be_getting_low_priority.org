...
* SOLVED: [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/disable_cpu_throttling_for_each_core.org][disable CPU throttling for each core]]
* refs
