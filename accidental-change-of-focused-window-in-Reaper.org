...
** cursor movement
   ...
   it's probably [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/that_left_right_behave_differently_in_arrange_view_and_edit_view_is_arguably_a_feature_not_a_bug_reaper.org][because focus is on the arrange view]].
** shade of title bar
